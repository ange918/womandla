                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-gold pl-6">
                    <h3 className="text-xl font-bold text-dark mb-2">
                      Phase Pilote : Bohicon
                    </h3>
                    <p className="text-gray-700 leading-relaxed">
                      Lancement opérationnel dans la ville carrefour de Bohicon.
                      Cette phase permet de tester notre modèle d'incubation et
                      de formation sur un échantillon représentatif de 150
                      jeunes femmes avant le déploiement national.
                    </p>
                  </div>
                  <div className="border-l-4 border-primary pl-6">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Extension progressive aux 76 autres communes du Bénin, en
                      s'appuyant sur les centres de promotion sociale et les
                      maisons de l'entreprise pour une couverture territoriale
                      totale.
                    </p>
                  </div>
                </div>
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                >
                  <span
                    className={`text-5xl font-bold ${item.color} block mb-2`}
                  >
                    {item.val}
                  </span>
              ...
              <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="md:w-1/2">
                  ...
                  <p className="text-gray-600 mb-8 leading-relaxed">
                    Notre action s'inscrit directement dans les Objectifs de
                    Développement Durable (ODD) des Nations Unies, notamment
                    l'ODD 1, 4, 5 et 8.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    {["ODD 4", "ODD 5", "ODD 8"].map((odd) => (
                      <div
                        key={odd}
                        className="w-16 h-16 bg-white rounded-lg shadow-sm flex items-center justify-center font-bold text-primary"
                      >
                        {odd}
                      </div>
                    ))}
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-sm text-gray-600">
                  <tr className="border-b border-gray-50">
                    <td className="p-6 font-medium text-dark">
                      Appui Direct & Financement par Commune
                    </td>
                    <td className="p-6">20 000 000 FCFA</td>
                    <td className="p-6">
